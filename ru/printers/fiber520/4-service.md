...
![remove top](/docs/hfe520/service/remove_top.jpg)
...
![service 1](/docs/hfe520/service/remove_cover.jpg)

Отключите разъем заменяемого принтблока.

![service 2](/docs/hfe520/service/printhead_wiring.jpg)

С помощью комплектного ключа ослабьте 2 винта, удерживающих заменяемый принтблок.

![service 3](/docs/hfe520/service/printblock_tighten.jpg)
...
![service 4](/docs/hfe520/service/extruder_tighten.jpg)
...
![plug_inject](/docs/hfe520/service/plug_inject.jpg)
...
![module_inject](/docs/hfe520/service/module_inject.jpg)

### Установка модуля

Перед установкой модуля убедитесь, что установочные гайки закручены на 1-2 оборота

![screws](/docs/hfe520/service/screws.jpg)
