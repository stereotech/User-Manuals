---
title: Вопросы по 3D-принтеру STE520
...
## Какие преимущества у принтера STE520 (кроме 2-х дополнительных осей печати) перед 3-х осевыми принтерами от других отечественных производителей, выпускаемых для промышленной печати тугоплавкими полимерами (Anisoprint, TotalZ, СпецАвиа, FDM 2.0)? 
...
## Так, например, в презентации и на ВКС было заявлено, что принтер может печатать композитными филаментами, в то время, как Anisoprint Composer оснащен доп. печатной головкой, добавляющей стекло-/углеволоконную нить непосредственно в само изделие при печати. 
...
## Также, у принтеров от остальных производителей область печати оснащена термокамерой с подачей нагретого воздуха. Если данные решения отсутствуют в конструкции принтера, то планируется ли внедрить их или их аналоги?
...
## При проектировании принтера использована кинематика 3+2, вместо «head-head» – с чем это связано и какие преимущества дает данная кинематика?
